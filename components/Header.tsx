...
import { FlowerIcon as Rose, Search, LogOut, Menu, X } from "lucide-react"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href="/community" className="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100">
              Community
            </Link>
